...
*/
//CICLA L'ARRAY STARWARSCHARACTER
//TROVA PROPRIETA NAME DI OGNI OGGETTO IN ESSO CONTENUTO
//INSERISCILA NEL MIO ARRAY
...
const eyeColor = { blue: [], yellow: [], brown: [], red: [], bluegrey: [] }
console.log(eyeColor)
/* ESERCIZIO 5
  Utilizza uno switch statement per inserire uno ad uno gli oggetti dei personaggi di "starWarsCharacters" negli array relativi al colore degli occhi precedentemente creati.
  Ogni personaggio dovrà finire nell'array corrispondente al suo colore degli occhi (al valore della sua proprietà "eye_color").
*/
for (i = 0; starWarsCharacters.length; i++) {
  switch (starWarsCharacters.eye_color) {
    case blue:
      eyeColor.blue.push(starWarsCharacter[i])
      break
    case yellow:
      eyeColor.yellow.push(starWarsCharacter[i])
      break
    case brown:
      eyeColor.brown.push(starWarsCharacter[i])
      break
    case red:
      eyeColor.red.push(starWarsCharacter[i])
      break
    case bluegrey:
      eyeColor.bluegrey.push(starWarsCharacter[i])
  }
}
